...
namespace ExpensesTrackerApp.Helpers
{
    ...
    {
        //customizes Swagger so that endpoints protected by [Authorize] are clearly shown as secured,
        //display correct responses, and integrate seamlessly with JWT Bearer tokens.
